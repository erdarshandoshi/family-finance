...
//   "SIP transaction"          → Quant/KFin "Your SIP transaction … is processed"
//                                (subject carries no other matchable phrase)
//   "your NPS account"          → NPS statements (KFin "…of your NPS account",
//                                Protean "…for your NPS account"); figures in the PDF
...
const SEARCH_QUERY  =
  'newer_than:10d ' +
  'subject:("Systematic Investment" OR "transaction confirmation" OR "SIP Confirmation" OR "SIP transaction" OR "New Purchase" OR "units allotted" OR "your NPS account") ' +
